...
export const curatedSources: SourceInput[] = [
  ...
  ign("Nyx Boss Guide (Final Boss)", "Nyx_Boss_Guide_(Final_Boss)", "bosses"),
  ...
  game8("All Social Links and Rank 10 Rewards", "435602", "social_links"),
  game8("Romance Guide", "439868", "social_links"),
  game8("Persona Compendium - All Personas", "439526", "personas"),
  game8("All Aeon Personas", "439613", "personas"),
  ...
  game8("Nyx Avatar Boss Guide", "470966", "bosses"),
